class CubeState:
    ...
    def rotate(self, side):
        ...
        if side == 'front':
            ...
            front[2] = front[0], front[1], front[2], left[0], left[1], left[2], back[0], back[1], back[2], right[0], \
            right[1], right[2]
        elif side == 'down':
            left[6], left[7], left[8], back[6], back[7], back[8], right[6], right[7], right[8], front[6], front[7], \
            front[8] = back[6], back[7], back[8], right[6], right[7], right[8], front[6], front[7], front[8], left[6], \
            left[7], left[8]
        elif side == 'back':
        ...
        main[0], main[1], main[2], main[3], main[4], main[5], main[6], main[7], main[8] = main[6], main[3], main[0], \
        main[7], main[4], main[1], main[8], main[5], main[2]
    ...
    def revrotate(self, side):
        ...
        if side == 'front':
            ...
            left[0], left[1], left[2], back[0], back[1], back[2], right[0], right[1], right[2], front[0], front[1], \
            front[2] = back[0], back[1], back[2], right[0], right[1], right[2], front[0], front[1], front[2], left[0], \
            left[1], left[2]
        elif side == 'down':
            left[6], left[7], left[8], back[6], back[7], back[8], right[6], right[7], right[8], front[6], front[7], \
            front[8] = front[6], front[7], front[8], left[6], left[7], left[8], back[6], back[7], back[8], right[6], \
            right[7], right[8]
        elif side == 'back':
            left[0], left[3], left[6], up[0], up[1], up[2], right[2], right[5], right[8], down[6], down[7], down[8] = \
        ...
        main[0], main[1], main[2], main[3], main[4], main[5], main[6], main[7], main[8] = main[2], main[5], main[8], \
        main[1], main[4], main[7], main[0], main[3], main[6]
